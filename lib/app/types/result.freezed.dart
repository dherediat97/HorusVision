...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(RepositoryError error) failure,
    required TResult Function(T data) success,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(RepositoryError error)? failure,
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({RepositoryError error});

  $RepositoryErrorCopyWith<$Res> get error;
}
...
class __$$FailureImplCopyWithImpl<T, $Res>
  ...
  @pragma('vm:prefer-inline')
  $RepositoryErrorCopyWith<$Res> get error {
    return $RepositoryErrorCopyWith<$Res>(_value.error, (value) {
...
abstract class Failure<T> implements Result<T> {
  const factory Failure({required final RepositoryError error}) =
      _$FailureImpl<T>;
